...
const CreateCampaignForm = ({ initialData = null, onSubmit }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (values) => {
      const imageUrl = await uploadImageToImgbb(values.picture);
      const payload = {
        ...values,
        image: imageUrl,
        tags: values.tags
      ...
      await onSubmit(payload); // support reusable submit handler
    },
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4">Donation Campaign Details</h2>
      ...
      <Formik
        initialValues={{
          ...
          longDescription: initialData?.shortDescription || "",
